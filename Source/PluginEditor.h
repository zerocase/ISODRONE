...
private:
    ...
    juce::Slider vowelMorphSlider;  // CHANGED: was ComboBox vowelSelector
    ...
    std::unique_ptr<SliderAttachment> vowelMorphAttachment;  // CHANGED: was ComboBoxAttachment vowelAttachment
